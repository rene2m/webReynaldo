...
<head>
    ...
    <title>REYHOGAR |Panel administrativo</title>
    <!-- Scripts -->
    ...
    <!-- Styles -->
    <link href="{{ secure_asset('dist/css/adminlte.min.css') }}" rel="stylesheet">
</head>
        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar bg-light elevation-4">
                ...
                <a href="{{ url('/home') }}" class="brand-link">
                    <!-- <img src=" url(../img/jldm_slider.png)" alt="REYHOGAR logo" class="brand-image img-circle"
                        style="opacity: .8"> -->
                    <span class="brand-text font-weight-light">REYHOGAR</span>
                </a>
                ...
                <div class="sidebar">
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        <div class="image">
                            <img src="{{ secure_asset('dist/img/avatar5.png')}}" class="img-circle elevation-2" alt="User Image">
                        </div>
                        <div class="info">
