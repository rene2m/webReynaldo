            ...
            <div class="row">
                <div class="col-12">
                    <div class="hero-text">
                        ...
                        <h1 class="tipeo1">VARIEDAD DE PROFESIONES </h1>
...
@section('products')
<div class="main">
    <h1 class="title_category">Escoja una de nuestras categorías de profesiones</h1>
    <hr class="style4">
    <ul class="cards">
      ...
      <li class="cards_item">
        <div class="card">
          ...
          <div class="card_image"><img  src="{{secure_asset('/img/servicios/'.$servicio->image)}}" alt="{{$servicio->image}}"></div>
          <div class="card_content">
            <h1 class="card_title">{{$servicio->name}}</h1>
            <hr>
            <p class="card_text">{{$servicio->descripcion}}</p> 
            <!-- corregir la direccion de esta ruta  -->
            <a class="btn card_btn" href="{{ route('searchServicio' , $servicio->slug)}}"> 
                VER MAS
            </a>
          </div>
        </div>
